...
<template>
  <div class="flex flex-col bg-dc-grey-800 w-[72px] pt-2 content-center">
    <div class="w-[72px] items-center flex relative mb-2 justify-center">
      <div class="h-12 w-12 rounded-[50%] mb-2 overflow-hidden bg-dc-grey-text hover:bg-dc-blue-800 transition-all duration-150 hover:rounded-[33%] hover:cursor-pointer
                            [&:hover>#pill-container>#pill]:h-5  [&>#pill-container>#pill]:h-2">
    ...
    <div v-for="server in props.servers" :key="server._id"
      ...
      <div
        class="h-12 w-12 bg-slate-400 cursor-pointer hover:rounded-[33%] hover:cursor-pointer transition-all duration-150"
